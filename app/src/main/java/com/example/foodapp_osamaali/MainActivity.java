...
import com.example.foodapp_osamaali.adaptor.CategoryAdaptor;
import com.example.foodapp_osamaali.adaptor.PopularAdapter;
import com.example.foodapp_osamaali.domain.CategoryDomain;
...
public class MainActivity extends AppCompatActivity {
    private RecyclerView.Adapter adaptor , adapter2;
    ...
    private void recyclerViewCategoryList()
    {
        ...
        adaptor = new CategoryAdaptor(category);
        recyclerViewCategoryList.setAdapter(adaptor);
    }
